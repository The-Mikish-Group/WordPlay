...
const GUIDE_SECTIONS = [
    ...
    { icon: "\uD83C\uDFAF", title: "Difficulty Tiers", body: "WordPlay matches puzzles to your skill level! There are four tiers: <b>Easy</b> (3\u20135 letter puzzles, great for beginners), <b>Medium</b> (full 6-letter puzzles), <b>Hard</b> (puzzles loaded with bonus words), and <b>Expert</b> (complex anagrams with 8\u201315+ bonus words).<br><br>Your tier is set automatically based on your progress. As you play through levels and cross into harder territory, you\u2019ll be <b>auto-promoted</b> with a celebration! You can also manually upgrade in <a href=\"#\" class=\"guide-link\" data-action=\"settings\">Settings</a> (but you can\u2019t go back down). Your level numbers always start at 1 \u2014 the tier just controls how challenging the puzzles are.<br><br><b>Note:</b> Speed milestones (5 fast levels = bonus puzzle) are disabled on Easy tier." },
