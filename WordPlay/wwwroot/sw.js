const CACHE_NAME = 'wordplay-v149';
const ASSETS = [
    '/',
    '/index.html',
    '/css/app.css?v=99',
    ...
    '/js/app.js?v=99',
    '/js/levels.js?v=99',
    '/js/level-loader.js?v=99',
    '/js/crossword.js?v=99',
    '/js/quests.js?v=99',
    '/js/honeycomb-core.js?v=99',
    '/js/honeycomb.js?v=99',
    '/js/bee-core.js?v=99',
    '/js/bee-collection.js?v=99',
    '/js/league.js?v=99',
    '/data/honeycomb.json',
    '/manifest.json',
...
const DATA_CACHE = 'wordplay-data-v13';
