...
IF NOT EXISTS (
    ...
    WHERE [MigrationId] = N'20260602013251_AddLeagues'
)
BEGIN
...
BEGIN
    ALTER TABLE [UserProgress] ADD [CurrentWeek] nvarchar(max) NOT NULL DEFAULT N'';
END;
...
BEGIN
    ...
    VALUES (N'20260602013251_AddLeagues', N'10.0.7');
END;
